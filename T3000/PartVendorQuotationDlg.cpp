...
BOOL CPartVendorQuotationDlg::OnInitDialog()
{
    ...
    m_data_list.InsertColumn(2, _T("Cost"), 50, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_data_list.InsertColumn(3, _T("AtLevel"), 80, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_data_list.InsertColumn(4, _T("Primary"), 50, ListCtrlEx::CheckBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_data_list.InsertColumn(5, _T("VendorP/N"), 100, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
...
void CPartVendorQuotationDlg::Initial_List()
{
    ...
    for (; i<(int)pn_table.m_dataset_VendorInfor_Part.size(); i++)
    {
        ...
        if (pn_table.m_dataset_VendorInfor_Part.at(i).Primary == -1)
        {
