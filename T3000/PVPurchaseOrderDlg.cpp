...
BOOL CPVPurchaseOrderDlg::OnInitDialog()
{
    ...
    m_static_purchase_date.SetWindowText(pn_table.m_dataset_po.at(0).POMNumber);
    m_static_purchase_date.setFont(30,10,NULL,_T("Arial"));

    m_RichEdit_TO.SetWindowText(pn_table.m_dataset_po.at(0).POMSupplier+"\n"+pn_table.m_dataset_po.at(0).POMAddress);
    m_RichEdit_TO.SetFontName(_T("Arial"));
    m_RichEdit_TO.SetFontSize(15);
    m_RichEdit_TO.SetReadOnly(TRUE);

    m_static_phone.SetWindowText(pn_table.m_dataset_po.at(0).POMSupplier_Phone);
    m_static_phone.setFont(15,10,NULL,_T("Arial"));

    m_static_attn.SetWindowText(pn_table.m_dataset_po.at(0).POMAttnTo);
    m_static_attn.setFont(15,10,NULL,_T("Arial"));
    m_static_account.SetWindowText(pn_table.m_dataset_po.at(0).POMAccount);
    m_static_account.setFont(15,10,NULL,_T("Arial"));

    m_RichEdit_SHIP_TO.SetWindowText(pn_table.m_dataset_po.at(0).POMShipTo);
    m_RichEdit_SHIP_TO.SetFontName(_T("Arial"));
    m_RichEdit_SHIP_TO.SetFontSize(15);
    m_RichEdit_SHIP_TO.SetReadOnly(FALSE);

    m_static_buyer.SetWindowText(pn_table.m_dataset_po.at(0).POMFromBuyer);
    m_static_buyer.setFont(15,10,NULL,_T("Arial"));

    m_static_contect.SetWindowText(pn_table.m_dataset_po.at(0).POMEngrgContact);
    m_static_contect.setFont(15,10,NULL,_T("Arial"));

    m_RichEdit_Date_Required.SetWindowText(pn_table.m_dataset_po.at(0).POMDateReq);
    ...
    m_RichEdit_Fob.SetWindowText(pn_table.m_dataset_po.at(0).POMFOB);
    m_RichEdit_Fob.SetFontName(_T("Arial"));
    m_RichEdit_Fob.SetFontSize(12);
    m_RichEdit_Fob.SetReadOnly(FALSE);

    m_RichEdit_Shipping_Method.SetWindowText(pn_table.m_dataset_po.at(0).POMShipMethod);
    ...
    m_RichEdit_Terms.SetWindowText(pn_table.m_dataset_po.at(0).POMTerms);
    m_RichEdit_Terms.SetFontName(_T("Arial"));
    m_RichEdit_Terms.SetFontSize(12);
    m_RichEdit_Terms.SetReadOnly(FALSE);

    m_RichEdit_Date.SetWindowText(pn_table.m_dataset_po.at(0).POMDatePrinted);
