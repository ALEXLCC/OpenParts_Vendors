...
BOOL CPVDetailedVendorDlg::OnInitDialog()
{
    ...
    for (int i = 0;i<pn_table.m_dataset_Currentcy.size ();i++)
    {
       ...
       m_currentcy =  m_currency.CURCurrencyName;
